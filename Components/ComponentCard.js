...
export default function({children, code='Soon', name=''}){
    ...
    <div className="py-10 flex-1">
        ...
        <div className="flex items-center justify-center relative h-[400px]">
            <div className="p-10 max-sm:p-2 flex items-center justify-center relative w-full h-full shadow-[0_0_1px_var(--text)] box-border my-5 rounded-lg"
                style={{
                ...
                >
                <h1 className="font-lg font-semibold absolute top-2 left-0 shadow-[0_0_1px_var(--text)] mx-2 px-2 py-1 rounded-md">{name}</h1>
                {children} 
            </div>
